...
def main():
    ...
    button_calc = tk.Button(root, command=Calculator, text="Calculator", font=('Terminal', 20), width=20, height=5)
    button_calc.place(x=50, y=450)

    button_calc = tk.Button(root, command=AnagramSolver, text="Anagram Solver", font=('Terminal', 20), width=20, height=5)
